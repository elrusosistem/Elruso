...
const STEPS = [
  {
    key: "what_to_achieve",
    title: "Que queres lograr?",
    subtitle: "Describe tu objetivo principal con este sistema.",
    placeholder: "Ej: Vender mas, automatizar procesos, mejorar marketing...",
    type: "textarea" as const,
  },
  {
    key: "how_today",
    title: "Como lo haces hoy?",
    subtitle: "Contanos brevemente como gestionas tu negocio actualmente.",
    placeholder: "Ej: Todo manual, uso planillas, tengo un sistema propio...",
    type: "textarea" as const,
  },
  {
    key: "tech_level",
    title: "Que nivel tecnico tenes?",
    subtitle: "Esto nos ayuda a adaptar las explicaciones.",
    type: "radio" as const,
    options: [
      { value: "none", label: "No tecnico", desc: "No tengo experiencia tecnica" },
      { value: "basic", label: "Basico", desc: "Entiendo conceptos generales" },
      { value: "intermediate", label: "Intermedio", desc: "Puedo configurar herramientas" },
      { value: "technical", label: "Tecnico", desc: "Se programar o administrar sistemas" },
    ],
  },
  {
    key: "current_stack",
    title: "Que plataforma o stack usas?",
    subtitle: "Contanos que herramientas usas para tu negocio.",
    placeholder: "Ej: Tiendanube, Shopify, WooCommerce, sistema propio...",
    type: "textarea" as const,
    extra: (
